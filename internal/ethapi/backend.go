...
func GetAPIs(apiBackend Backend, relayUrl *string) []rpc.API {
	...
	return []rpc.API{
		{
			...
			Namespace: "eth",
			Service:   NewTransactionAPI(apiBackend, nonceLock, relayUrl),
		}, {
			Namespace: "txpool",
			...
			Namespace: "personal",
			Service:   NewPersonalAccountAPI(apiBackend, nonceLock, relayUrl),
		},
	}
}
